/**
 * @fileoverview Menu de navegação padrão (para desenvolvimento/compatibilidade)
 * @module constants/menus/default
...
/**
 * Menu de navegação padrão (para desenvolvimento/compatibilidade)
 * @type {NavMenu[]}
 * @deprecated Use userMenu ou adminMenu baseado no papel do usuário
 */
...
/**
 * Menu de navegação inferior padrão (para compatibilidade)
 * @type {NavMenuItems}
 * @deprecated Use userMenuBottom ou adminMenuBottom
 */
