<!--
  @fileoverview Página administrativa para editar perfil do usuário
  @module pages/admin/user/profile/[id]
  @author Raffle System
-->
<script setup lang="ts">
import { computed } from 'vue'
import { getUserById, mockUsers } from '~/data/mocks/users'
 ...
 */
useHead({
  title: () => `Editar Perfil - ${selectedUser.value?.name || 'Usuário'}`,
})
  ...
  <div class="pb-16 space-y-6">
    ...
    <div class="flex flex-col lg:flex-row space-y-6 lg:space-x-12 lg:space-y-0">
      ...
      <div class="flex-1 lg:max-w-2xl">
        <div class="space-y-6">
          <SettingsProfileForm :user-id="userId.value" :is-admin="true" />
        </div>
      </div>
    </div>
  </div>
