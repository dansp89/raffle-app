<!--
  @fileoverview Página administrativa para editar display do usuário
  @module pages/admin/user/display/[id]
 ...
 */
useHead({
  title: () => `Editar Display - ${selectedUser.value?.name || 'Usuário'}`,
})
  ...
  <div class="pb-16 space-y-6">
    ...
    <div class="flex flex-col lg:flex-row space-y-6 lg:space-x-12 lg:space-y-0">
      ...
      <div class="flex-1 lg:max-w-2xl">
        <div class="space-y-6">
          <SettingsDisplayForm :user-id="userId.value" :is-admin="true" />
        </div>
      </div>
    </div>
  </div>
